...
| File | Description |
| - | - |
| `training\_curves.png` | Loss and accuracy over 20 epochs |
| `per\_class\_accuracy.png` | Per-class bar chart (color coded) |
| `confusion\_matrix.png` | 29×29 normalized confusion matrix |
...
│  
├── ASL\_DL\_Part.ipynb          \# Part 1: CNN training and evaluation (my section)  
├── ASL\_NLP\_Part.ipynb         \# Part 2: NLP pipeline (partner's section)  
│  
├── outputs/  
│   ├── asl\_cnn.pth            \# Trained model weights  
│   ├── training\_curves.png  
│   ├── per\_class\_accuracy.png  
...
1. Open `ASL\_DL\_Part.ipynb` in Google Colab

2. Set runtime to **T4 GPU**: `Runtime → Change runtime type → T4 GPU`

3. Run all cells top to bottom — the Kaggle token is already embedded

4. Training takes ~60–90 minutes. The best model is auto-saved as `asl\_cnn.pth`

5. Final cell downloads all outputs as a `.zip`

### Run Part 2 (NLP)

1. Open `ASL\_NLP\_Part.ipynb`

2. Upload `asl\_cnn.pth` from Part 1 outputs
...
![Python](https://img.shields.io/badge/Python-3.10-blue?logo=python) ![PyTorch](https://img.shields.io/badge/PyTorch-2.x-orange?logo=pytorch) ![HuggingFace](https://img.shields.io/badge/HuggingFace-Transformers-yellow?logo=huggingface) ![OpenCV](https://img.shields.io/badge/OpenCV-4.x-green?logo=opencv)
...
| Name | Role | LinkedIn |
| - | - | - |
| Thubalami Nkomazana | ML / Deep Learning | https://www.linkedin.com/in/thubalami-nkomazana15 |
| Rohan Ajith Shankar Pilli | NLP Pipeline | https://www.linkedin.com/in/rohan-ajith-shankar |
